...
@dataclass
class IconCandidate:
    """Detected source icon region before cleanup and normalization."""
...
class InputAnalysis:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "estimated_icon_count": self.estimated_icon_count,
...
@dataclass
class IconRecord:
    """Fully processed icon and metadata used during packaging."""
