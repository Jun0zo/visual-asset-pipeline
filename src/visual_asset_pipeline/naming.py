...
def _position_name(candidate: AssetCandidate) -> str:
...
def generate_asset_names(
    candidates: list[AssetCandidate],
    representative_images: list,
    prompt: str | None = None,
    names_file: Path | None = None,
) -> list[str]:
    """Generate stable semantic filenames. Never returns asset1/icon1 style names."""
...
def tags_for_asset(name: str, prompt: str | None, colors: list[str]) -> list[str]:
