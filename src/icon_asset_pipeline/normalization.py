...
def normalize_icon(image: Image.Image, sizes: tuple[int, ...], padding_ratio: float) -> dict[int, Image.Image]:
    """Center an icon optically and export square transparent canvases."""
