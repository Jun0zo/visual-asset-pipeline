...
- Add a learned detector trained on icon sheets, stickers, app icons, game UI atlases, and hand-drawn packs.
...
- Add CI visual tests using synthetic and real-world icon sheets.
